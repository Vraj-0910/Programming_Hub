        ...
        if ($count > 0) {
           ...
           // $response["blog"] = array();
            ...
            if($countanremove > 0){
				  ...
				  $checkblog = mysqli_query($conn, "select * from tbl_blog_action where blog_id='{$row['blog_id']}'  and is_delete='0' and is_active='1'") or die(mysqli_error($conn));
                $getblog = mysqli_fetch_array($checkblog);
...
//                if($getblog["is_upvote_downvote"] == '0')
//                {
//                $is_upvote = "0";    
//                }else if($getblog["is_upvote_downvote"] == '1') {
//					$is_upvote = "1";   
//				}
//                else{
//                    $is_upvote = "2";    
